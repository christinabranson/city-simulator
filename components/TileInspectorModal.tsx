...
export const TileInspectorModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-slate-950/70 p-4">
      <div className="flex h-[75vh] w-full max-w-md flex-col rounded-lg border border-slate-700 bg-slate-900 p-4 shadow-2xl">
        ...
        <div className="min-h-0 flex-1 space-y-4 overflow-y-auto pr-1">
          ...
          {movingBuilding ? (
            <div className="rounded bg-amber-900/30 p-3 text-xs text-amber-200">
